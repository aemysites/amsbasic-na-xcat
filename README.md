...
## Environments
- Preview: https://main--amsbasic-na-xcat--aemysites.aem.page/
- Live: https://main--amsbasic-na-xcat--aemysites.aem.live/
- Block Library: https://main--amsbasic-na-xcat--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `amsbasic-na-xcat` directory in your favorite IDE and start coding :)
